        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @can("create", App\Model\Vacante::class)
                        <a 
                            class="mr-2 w-7 h-7 bg-indigo-400 hover:bg-indigo-700 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white" 
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if (Auth::user()->rol === 2)
                    <div class="flex gap-2 items-center p-3">
                        <a 
                            class="w-7 h-7 bg-indigo-400 hover:bg-indigo-700 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white" 
                            href="{{ route("notificaciones") }}">
                            {{ Auth::user()->unreadNotifications->count() }}
                        </a>
