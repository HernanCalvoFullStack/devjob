<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Debes confirmar tu cuenta antes de continuar. Hemos enviado un enlace a tu email para confirmar la cuenta.') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('Hemos enviado un nuevo email de confirmación a tu cuenta de email de Registro.') }}
        </div>
    @endif
